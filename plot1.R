...
#create output path
plot1_filename <- file.path(output_dirname, "plot1.png") 

# graph the data & save to file
dev.copy(png, plot1_filename, width=480, height=480)
hist(plot_data$Global_active_power, breaks = seq(0,8, by=0.5), main="Global Active Power", xlab = "Global Active Power (kilowatts)", ylim=c(0, 1200), col = "red", bg=NA, xaxt='n')
